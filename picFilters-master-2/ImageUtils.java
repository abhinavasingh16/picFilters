...
public class ImageUtils {
   ...
   */
  public static PixImage buffer2PixImage(BufferedImage bImage) {
   ...
   */
  public static BufferedImage readTIFF(String filename) {
   ...
   */
  public static void writeTIFF(BufferedImage image, String filename) {
