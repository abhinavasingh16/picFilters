...
public class RunIterator implements Iterator {
  ...
  // the encoding.
  RunIterator(DList1 runlength,DListNode1 currNode) {
    runLength = runlength;
  ...
  public int[] next() {
    if (! this.hasNext()){
      throw new IndexOutOfBoundsException();
        ...
        currentNode = runLength.head;
        int[] status = {currentNode.run,currentNode.red,currentNode.green,currentNode.blue};
        return status;
    }
